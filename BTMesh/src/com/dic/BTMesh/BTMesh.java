 ...
 */
public class BTMesh extends Activity {
    // Debugging
    ...
    private String convoToString() {
    	String flat = "";
    	for (int i = 0; i < mConversationArrayFull.getCount(); i++){
    		BTMessage m = mConversationArrayFull.getItem(i);
    ...
    private void sendData(){
    	byte[] send = convoToString().getBytes();
    	mChatService.write(send);
    }
