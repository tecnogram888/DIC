...
//    private Context context;
    ...
    public BTMeshService(Context c, Handler handler, BTMeshState s) {
        ...
        mHandler = handler;
        mStateNode = new BTStateNode(mAdapter.getAddress(), mAdapter.getName());
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, int channel) {
        ...
        mStateNode.newNode(channel, device.getAddress(), device.getName());
            ...
            try {
        		if (mConnectedThreads.get(channel) == null) {
                    ...
                    if (socket != null) {
	                    ...
	                    //mSockets.add(socket);
                    	mStateNode.newNode(channel, address, name);
